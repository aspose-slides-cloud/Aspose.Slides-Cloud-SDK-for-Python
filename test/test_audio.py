...
class TestAudio(BaseTest):
    ...
    def test_caption_tracks(self):
        ...
        BaseTest.slides_api.create_caption_track(self.file_name, slide_index, shape_index, track1_label, track1_data, self.password, self.folder_name)
        BaseTest.slides_api.create_caption_track(self.file_name, slide_index, shape_index, track2_label, track2_data, self.password, self.folder_name)
        captions = BaseTest.slides_api.get_caption_tracks(self.file_name, slide_index, shape_index, True, self.password, self.folder_name)
        ...
        BaseTest.slides_api.delete_caption_track(self.file_name, slide_index, shape_index, 1, self.password, self.folder_name)
        captions = BaseTest.slides_api.get_caption_tracks(self.file_name, slide_index, shape_index, False, self.password, self.folder_name)
        ...
        BaseTest.slides_api.delete_caption_tracks(self.file_name, slide_index, shape_index, self.password, self.folder_name)
        captions = BaseTest.slides_api.get_caption_tracks(self.file_name, slide_index, shape_index, False, self.password, self.folder_name)
        self.assertEqual(0, len(captions.items))
